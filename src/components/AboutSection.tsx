    ...
    >
      <div ref={ref} className="container mx-auto px-4 max-w-3xl">
        ...
        <div className={`space-y-4 text-muted-foreground leading-relaxed transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <p>
            Mi nombre es <span className="text-foreground font-semibold">Iris Horny von Bories</span>. 
          ...
          <p>
            Soy Licenciada en Administración de Empresas, tengo dos maestrías enfocadas en el negocio 
            corporativo digital. A lo largo de mi carrera profesional he liderado la planificación, 
            gestión y optimización de campañas en plataformas como Google Ads, Meta, LinkedIn, Spotify y X, 
            administrando presupuestos superiores a USD 100,000.
          </p>
          <p>
            Dentro del Club CRECER, mi objetivo es ayudar a los emprendedores a desarrollar y 
            optimizar su estrategia de Marketing Digital como parte de su proceso de transformación digital, 
            con un enfoque en resultados y sostenibilidad.
          </p>
        </div>
